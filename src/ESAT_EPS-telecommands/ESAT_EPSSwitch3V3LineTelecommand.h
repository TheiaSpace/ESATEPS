...
// Used by ESAT_EPS.
class ESAT_EPSSwitch3V3LineTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the EPS_SWITCH_3V3_LINE telecommand.
    static const byte EPS_SWITCH_3V3_LINE = 0x10;
