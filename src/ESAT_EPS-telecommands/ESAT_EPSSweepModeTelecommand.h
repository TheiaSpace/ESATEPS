...
#ifndef ESAT_EPSSweepModeTelecommand_h
#define ESAT_EPSSweepModeTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSPacketConsumer.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for EPS_SWEEP_MODE.
// Used by ESAT_EPS.
class ESAT_EPSSweepModeTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the EPS_SWEEP_MODE telecommand.
    static const byte EPS_SWEEP_MODE = 0x21;
...
// Global instance of ESAT_EPSSweepModeTelecommandClass.
// Used by ESAT_EPS.
extern ESAT_EPSSweepModeTelecommandClass ESAT_EPSSweepModeTelecommand;
