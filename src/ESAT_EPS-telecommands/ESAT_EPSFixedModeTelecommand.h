...
#ifndef ESAT_EPSFixedModeTelecommand_h
#define ESAT_EPSFixedModeTelecommand_h

#include <Arduino.h>
#include <ESAT_CCSDSPacketConsumer.h>
#include <ESAT_SemanticVersionNumber.h>

// Telecommand handler for EPS_FIXED_MODE.
// Used by ESAT_EPS.
class ESAT_EPSFixedModeTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the EPS_FIXED_MODE telecommand.
    static const byte EPS_FIXED_MODE = 0x22;
...
// Global instance of ESAT_EPSFixedModeTelecommandClass.
// Used by ESAT_EPS.
extern ESAT_EPSFixedModeTelecommandClass ESAT_EPSFixedModeTelecommand;
