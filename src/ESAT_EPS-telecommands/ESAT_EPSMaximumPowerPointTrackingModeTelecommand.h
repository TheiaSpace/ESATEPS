...
// Used by ESAT_EPS.
class ESAT_EPSMaximumPowerPointTrackingModeTelecommandClass: public ESAT_CCSDSPacketConsumer
{
  public:
  ...
  private:
    // Identifier of the EPS_MAXIMUM_POWER_POINT_TRACKING_MODE telecommand.
    static const byte EPS_MAXIMUM_POWER_POINT_TRACKING_MODE = 0x20;
